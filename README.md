...
# Analyses 
  ...
  06_supplemental_figures.R: code to generate supplemental figures 
...
plotpairs.csv: blocking structure of biomass plots
  plotpasture = unique plot pastue identifier
  pair = identifier of paired plots within block
  block = blocking identifier 
